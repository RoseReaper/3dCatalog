...
CREATE TABLE is_found_on(
	website_id Int NOT NULL,
	content_id Int NOT NULL,
    CONSTRAINT is__found_on_PK PRIMARY KEY (website_id,content_id),
    CONSTRAINT is__found_on_WEBSITE_FK FOREIGN KEY (website_id) REFERENCES WEBSITE(website_id),
    CONSTRAINT is__found_on_CONTENT0_FK FOREIGN KEY (content_id) REFERENCES CONTENT(content_id)
)ENGINE=InnoDB;